...
using MobileApps.WebApi.JWT;
using DevExpress.ExpressApp.Security.Authentication;
using DevExpress.ExpressApp.Security.Authentication.ClientServer;
using MobileApps.WebApi.Core;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services
            .AddXafWebApi(Configuration, options => {
                ...
                options.BusinessObject<NhatKyCanhTac>();
                options.BusinessObject<ChiTietNhatKy>();
                options.BusinessObject<CongViec_TinhTrang>();
                options.BusinessObject<Dat_CoSo>();
                options.BusinessObject<LoaiCayTrong>();
                options.BusinessObject<QuyTrinhSanXuat>();
                options.BusinessObject<NguyenLieu>();
                ...
                options.BusinessObject<TaiLieu>();
            })
            .AddXpoServices();
        services
            .AddControllers()
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "MobileApps API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the MobileApps.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "MobileApps WebApi v1");
            });
        }
        else {
