...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "ApiWebsite API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the ApiWebsite.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
        });
    }
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ApiWebsite WebApi v1");
            });
        }
        else {
